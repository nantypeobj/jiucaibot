...
#import os,sys
##cwd = os.getcwd()
#os.chdir(path=r'C:\Users\Administrator.ZX-201609072125\Desktop\stockdata-master\BTCdata\OKCRAWLER')
import socket
import socks
...
#        requests.get(r'http://www.google.com', timeout=24)
    ...
    def request(self,url,method,headers={},params={}):
        ...
        if method=='GET':
            return requests.get(url,timeout=settings.TIMEOUT,**otherpara)
        else:
            return requests.post(url,data=params,headers=headers,**otherpara)  
    ...
    def request_post(self,url,headers={},params={},formattype='json'):
        print ('....requesting url:'+url)
        ...
        res=self.request(url,'POST',headers=headers,params=params)
        return self._request_format(res,formattype=formattype)
